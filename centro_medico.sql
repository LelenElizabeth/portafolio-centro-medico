...
INSERT INTO usuarios (id_perfil, rut, nombres, apellido1, apellido2, fecha_nacimiento, genero, direccion, comuna, telefono, correo, perfil, usuario, contrasena)
VALUES
    (2, '11111111-1', 'Pedro Andres', 'Ramírez', 'González', '1980-09-10', 'Masculino', 'Avenida 789', 'Concepción', '456789012', 'pedro@example.com', 'Medico', 'pramirez', '$2a$12$VbdfOpNAjk252r8rNufKreuA8VqxRwF5dgl9fHBYoAl5RhGEcQj9C'),
    (2, '22222222-2', 'Ana Lucia', 'Martínez', 'Pérez', '1975-07-25', 'Femenino', 'Calle 987', 'Santiago', '222222222', 'ana@example.com', 'Medico', 'amartinez', '$2a$12$VbdfOpNAjk252r8rNufKreuA8VqxRwF5dgl9fHBYoAl5RhGEcQj9C'),
    (1, '33333333-3', 'Carlos Eduardo', 'González', 'López', '1995-03-12', 'Masculino', 'Calle 555', 'Valparaíso', '123456789', 'carlos.gonzalez@centromedico.com', 'Administrativo', 'cgonzalez', '$2a$12$VbdfOpNAjk252r8rNufKreuA8VqxRwF5dgl9fHBYoAl5RhGEcQj9C'),
    (1, '44444444-4', 'Sofía Antonia', 'Hernández', 'Silva', '1988-12-01', 'Femenino', 'Avenida 222', 'Concepción', '999999999', 'sofia.hernandez@centromedico.com', 'Administrativo', 'shernandez', '$2a$12$VbdfOpNAjk252r8rNufKreuA8VqxRwF5dgl9fHBYoAl5RhGEcQj9C'),
    (3, '18249054-7', 'Marlene Elizabeth', 'Castro', 'Pinto', '1992-11-12', 'Femenino', 'Avenida 333', 'Concepción', '999999999', 'marlene.castro@centromedico.com', 'Sistemas', 'mcastro', '$2a$12$VbdfOpNAjk252r8rNufKreuA8VqxRwF5dgl9fHBYoAl5RhGEcQj9C');
