		...
		<div
			...
			<c:set var="mensaje" value="${mensaje}" />
				...
				<div class="card-header text-white bg-primary opacity-75">
					<h2 class="card-title d-flex justify-content-center bg-primary opacity-75" >Crear
						Paciente</h2>
				...
				<div class="card-body">
					<form action="crear-paciente" id="formulario" class="row" method="post">
						...
						<div class="col-md-12">
							<button type="submit" class="btn btn-primary opacity-75 w-100 mt-4">Grabar</button>
						</div>
					</form>
				</div>
			</div>
