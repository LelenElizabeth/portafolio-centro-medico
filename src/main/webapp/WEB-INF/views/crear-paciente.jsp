	...
	<main class="flex-shrink-0">
		...
		<div class="align-items-center mt-4 container">
				...
				<span class="border border-info">
					<c:set var="mostrarAlert" value="${mostrarAlert}" /> <c:set
						var="mensaje" value="${mensaje}" />

					<div class="card-header text-info">
						<h2 class="card-title d-flex">
							<i class="bi bi-clipboard-plus"></i> Crear Paciente
						</h2>
					</div>
					<div class="card-body">
				</span>
				<form action="GuardarPaciente" id="formulario" class="row"
					method="POST">
					...
					<div class="col-md-6 mb-3">
						<label for="datepicker" class="form-label">Fecha de
							Nacimiento</label>
					...
					<div class="col-md-12 d-flex justify-content-end">
						<button type="submit" class="btn btn-info mt-4 btn-lg">
							Grabar <i class="bi bi-clipboard-plus"></i>
						</button>
					</div>
				</form>
			</div>
